package info.coremodding.api.compat.item;

import info.coremodding.api.compat.CompatibilityModule;
import info.coremodding.api.compat.Electricity;
import info.coremodding.api.compat.energy.UnitDisplay;
import info.coremodding.api.compat.energy.UnitDisplay.Unit;
...
{ 
    ...
    {
        return Electricity.DEFAULT_VOLTAGE;
    }
