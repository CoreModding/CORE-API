package info.coremodding.api.compat.energy;

import info.coremodding.api.compat.energy.net.INodeNetwork;
import info.coremodding.api.compat.energy.net.IUpdate;
