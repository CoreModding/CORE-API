...
public class RegistrationHandler
{
     ...
     * 
     * @param name
     *            Name for which to return the achievement
     * @return Achievement
     */
     ...
     * 
     * @param name
     *            Name for which to return the item
     * @return Item
     */
     ...
     * 
     * @param name
     *            Name of the achievement to register
     * @param achievement
     ...
     * 
     * @param name
     *            Name of the armor (eg. "flameArmor")
     * @param helmet
     *            Helmet armor piece
     * @param chestplate
     ...
     *            Boots armor piece
     */
    public static void registerArmorSet(String name, Item helmet,
