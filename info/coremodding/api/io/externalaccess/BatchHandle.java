...
public class BatchHandle {
	...
	/**
	 * @return Returns the output of the writeline and return value of the DLL method being called via batch
	 */
	 ...
	 */
	protected static void createDLLRunBatch(String args, String dllPath, String methodorfunct) {
		...
		IOUtils.writeFile("C:\\tmpcmd.cmd", new String[]{"@ECHO OFF", "rundll32 " + dllPath + "," + methodorfunct + " \"" +  args +"\" > tmpout.txt"});
	}
