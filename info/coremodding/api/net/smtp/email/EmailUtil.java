...
public class EmailUtil {
	 ...
	 */
	public static void sendEmail(String host, List<String> tos, String from, String namefrom, String subject, String message, List<EmailAttachment> attachments) throws EmailException{
	 ...
	 */
	public static EmailAttachment createAttachment(String path, String desc, String name, boolean urlnotpath) throws MalformedURLException{
